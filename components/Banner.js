function Banner() {
  return (
    <div className="h-screen bg-zinc-900">
      <div className="relative items-center flex flex-col bg-fixed justify-center bg-[url(/assets/images/dino-background2.png)] bg-no-repeat h-full bg-cover bg-center">
